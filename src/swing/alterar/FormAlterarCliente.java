...
public class FormAlterarCliente extends javax.swing.JFrame {
    ...
    public FormAlterarCliente(Customer cliente, int id) {
        ...
        index = id;
        jTextField1.setText(this.clienteAlterar.getName());
        jTextField2.setText(this.clienteAlterar.getAddress());
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            clienteAlterar.setName(jTextField1.getText()); // TODO add your handling code here:
            clienteAlterar.setAddress(jTextField2.getText());
            FachadaCustomers.getInstance().editCustomer(this.index,clienteAlterar);
